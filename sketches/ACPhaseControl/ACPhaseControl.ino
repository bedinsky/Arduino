...
#define AC_PIN 3	// Output to Opto Triac
...
void setup()
{
    Serial.begin(9600);	//start the serial port at 115200 baud we want
    ...
    pinMode(LED, OUTPUT);
    attachInterrupt(0, zero_cross_detect, RISING); 	// Attach an Interupt to Pin 3 (interupt 1) for Zero Cross Detection
